...
public class GCMIntentService extends IntentService {
		...
		if (!extras.isEmpty()) { // has effect of unparcelling Bundle
			...
			if (GoogleCloudMessaging.MESSAGE_TYPE_SEND_ERROR
				...
				if (messageSplit[0].equals("add")) {
					Log.i("TAG", "RECEIVING AN ADD MESSAGE data "
							+ messageSplit[1]);
					Log.i("TAG", "RECEIVING AN ADD MESSAGE data "
							+ messageSplit[2]);
					Log.i("TAG", "RECEIVING AN ADD MESSAGE data "
					...
					Log.i("TAG", "RECEIVING AN ADD MESSAGE data "
							+ messageSplit[7]);
					Log.i("TAG", "RECEIVING AN ADD MESSAGE regId "
							+ messageSplit[8]);
					String myEventString = messageSplit[1].toString();

					String phoneRegId = messageSplit[8];
					Log.i("TAG", "REGID BRAHHHHHH LIKE WATTTT "
							+ MainActivity.regid);
					...
					/*
					 * try { Event event=new Event(); JSONArray myArray = new
					 * JSONArray(myEventString);
					...
					// new
					// PersonalEventDbHelper(getApplicationContext()).removeEntry(Long.parseLong(messageSplit[1]));
				}
			}
	 ...
	 * 
	 * 
	 * @Override protected void onUnregistered(Context arg0, String arg1) { if
	 * (GCMRegistrar.isRegisteredOnServer(arg0))
