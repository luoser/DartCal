...
//	private static String SENDER_ID = "661817626973"; //"286158326826";
...
//	        			Log.i("TAG","COUNTER"+Globals.COUNTER);
...
//			
//								Globals.myEventsArray.add(myEvent);
//	
//	        	}
//	        	Log.i("TAG","COUNTER Before if "+Integer.toString(Globals.COUNTER)+ "Size before if"+ Integer.toString(size));
//	        	if (Globals.COUNTER==size){
//	        		Log.i("TAG","INSIDE THE COUNTER==SIZE");
//	        		db.removeEntries();
//	        		Globals.COUNTER=0;
//	        		for (int i=0;i<Globals.myEventsArray.size();i++){
//	        			Event theseEntries=Globals.myEventsArray.get(i);
//	        			db.insertEntry(theseEntries);
//	        		}
//	        		Globals.myEventsArray.clear();
//	        		ArrayList<Event> myArray = db.fetchEntries();
//	        		for (int i=0;i<myArray.size();i++)
//	        			Log.i("TAG","WHAT AM I INSERTING"+myArray.get(i).getEventName());
//	        	}
//	       }     
//    }    
